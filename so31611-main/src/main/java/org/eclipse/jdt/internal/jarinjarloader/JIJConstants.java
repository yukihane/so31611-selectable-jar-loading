...
public final class JIJConstants {
    ...
    public static final String JAR_INTERNAL_URL_PROTOCOL_WITH_COLON = "jar:rsrc:";  //$NON-NLS-1$
    public static final String JAR_INTERNAL_SEPARATOR               = "!/";  //$NON-NLS-1$
    public static final String INTERNAL_URL_PROTOCOL_WITH_COLON     = "rsrc:";  //$NON-NLS-1$
    public static final String INTERNAL_URL_PROTOCOL                = "rsrc";  //$NON-NLS-1$
